...
function shoestrap_register_controls( $wp_customize ){
  ...
  $select_controls[] = array( 'setting' => 'shoestrap_responsive',              'label' => 'Responsive / Fixed-width / Fluid',        'section' => 'shoestrap_layout',      'priority' => 1, 'choises' => array( '1' => __( 'Responsive', 'shoestrap' ), '0' => __( 'Fixed-Width', 'shoestrap' ), 'fluid' => __( 'Fluid', 'shoestrap' ) ) );
